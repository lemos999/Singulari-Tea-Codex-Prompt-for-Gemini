...
4.  실행: 생성된 `master_prompt.txt`의 전체 내용을 Gemini 2.5 Pro를 지원하는 환경에 입력하여 시뮬레이션을 시작합니다.
...
4.  Execution: Input the entire content of the generated `master_prompt.txt` into an environment that supports Gemini 2.5 Pro to start the simulation.
